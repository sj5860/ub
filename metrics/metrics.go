...
var (
	...
	MessageReceivedBytes                = stats.Int64("message/recbytes", "Counter for total received messages", stats.UnitDimensionless)
	MessageValidationFailure            = stats.Int64("message/failure", "Counter for message validation failures", stats.UnitDimensionless)
	MessageValidationSuccess            = stats.Int64("message/success", "Counter for message validation successes", stats.UnitDimensionless)
	MessageValidationDuplicate          = stats.Int64("message/duplicate", "Counter for duplicate messages received", stats.UnitDimensionless)
	MessageValidationDuplicateBytes     = stats.Int64("message/dupbytes", "Bytes count of duplicate messages received", stats.UnitDimensionless)
